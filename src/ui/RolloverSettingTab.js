...
export default class RolloverSettingTab extends PluginSettingTab {
  ...
  async display() {
    ...
    new Setting(this.containerEl)
      ...
      new Setting(this.containerEl)
      .setName('Auto rollover todos from previous day')
      .setDesc(`When app.vault.on('create') event emit, this plugin will execute auto rollover`)
      .addToggle(toggle => toggle
        .setValue(this.plugin.settings.autoRollover || false)
        .onChange(value => {
